<template>
  <div class="w-screen h-screen overflow-hidden">
    ...
    >
      <div
        class="font-bolder text-2xl cursor-pointer flex items-center"
      ...
      >
        ...
        CHINESE LEARNING HOUSE
      </div>
      <div class="flex-grow"></div>
      <NuxtLink class="h-16 flex items-center text-lg px-4 btn" to="/home">
        Home
      </NuxtLink>
      <NuxtLink class="h-16 flex items-center text-lg px-4 btn" to="/post">
        Post
      </NuxtLink>
      <NuxtLink class="h-16 flex items-center text-lg px-4 btn" to="/contact">
        Contact
      </NuxtLink>
    </div>
    <div class="w-screen h-screen overflow-y-scroll" @scroll="onScroll">
      <NuxtChild></NuxtChild>
    </div>
  </div>
</template>
...
<style scoped>
.nuxt-link-active {
  background-color: rgba(255, 135, 80, 0.5);
}
</style>

<template>
  <div class="w-screen h-screen overflow-hidden">
    ...
    >
      <div
        class="font-bolder sm:text-2xl text-lg cursor-pointer flex items-center"
      ...
      <NuxtLink class="h-16 flex items-center px-4" to="/home">
        Home
      </NuxtLink>
      <NuxtLink class="h-16 flex items-center px-4" to="/post">
        Post
      </NuxtLink>
      <NuxtLink class="h-16 flex items-center px-4" to="/contact">
        Contact
      </NuxtLink>
    </div>
